    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12">
      ...
      <div className="max-w-3xl mx-auto text-center mb-12">
        <div className="flex justify-center mb-4">
          <Globe2 className="w-16 h-16 text-blue-700 drop-shadow-sm" />
        </div>
        <h1 className="text-5xl font-extrabold text-blue-900 mb-4 drop-shadow-sm">Our Services</h1>
      ...
      <div className="max-w-4xl mx-auto mb-16">
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          <div className="flex-1 bg-white/70 backdrop-blur-lg rounded-2xl shadow-sm border border-blue-100 p-8 flex flex-col items-center text-center hover:scale-105 transition-transform">
      ...
      {/* FAQ Section */}
      <div className="max-w-2xl mx-auto bg-white/80 backdrop-blur-lg rounded-2xl shadow-sm border border-blue-100 p-8">
